...
# #else
#   // Soltution: Secret solution; not for students to see.
# #endif
# 
#
# Requirements
...
for($i =0; $i -lt $files.Length; $i++)
{
  ...
  & $unifdef -UASSIGNMENT_STUB -o $outFile $inFile
...
$archiveName = (Get-Item -Path ".\").BaseName + "_Solution.zip"
