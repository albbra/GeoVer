...
#ifndef COGRA_IO_COGRARYBINARYMESHFILE_H_
#define COGRA_IO_COGRARYBINARYMESHFILE_H_
#include <vector>
#include <string>
#include <memory>
...
namespace io
{
//! \brief Binary fie for triangle meshes.
//!
...
public:
  ...
  //! Copy construction.
  CograBinaryMeshFile(CograBinaryMeshFile&& other);
  ...
  //! \param[in]  nComponents Number of components of each attribute element. For example, a normal vector attribute has 3 components. So you would place a 3 here.
  //! \param[in]  componentSize Number of bytes each component has. For example, a normal vector consists of floats, i.e. sizeof(float32) = 4. So you would place a four here.
  //! \param[in]  attributeName Name of the attribute. Names having more than N_CHARS characters are chopped.
  //! \return Number of attribute arrays.
  SizeType addAttribute(const void* attribute,
                        SizeType nComponents,
  ...
  //! \param[in]  nComponents Number of components the constant. For example, a light direction vector has 3 components. So you would place a 3 here.
  //! \param[in]  componentSize Number of bytes each component has. For example, a light direction vector consists of floats, i.e. sizeof(float32) = 4. So you would place a four here.
  //! \param[in]  name Name of the constant. Names having more than N_CHARS characters are chopped.
  //! \return Number of constants.
  SizeType addConstant(const void* constant,
                       SizeType nComponents,
                       SizeType componentSize,
  ...
  //!
  //! For a normal vector that would be 4, as a normal vector consists of floats, and sizeof(float32)=4.
  //!
  ...
  //!
  //! For a light direction vector that would be 4, as a light direction vector consists of floats, and sizeof(float32)=4.
  //!
